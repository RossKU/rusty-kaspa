...
/// redeemScripts (pre-v18 absolute-sompi semantics, superseded by the v18
/// generation's basis-points scale).
...
/// Default maximum matcher fee in BASIS POINTS (v18 semantics;
