...
mod tests {
    ...
    fn test_parse_buy_v12_rs_default() {
        ...
        assert_eq!(rs.len(), BUY_RS_SIZE, "Buy RS must be 409 bytes");
    ...
    fn test_parse_sell_v12_rs_default() {
        ...
        assert_eq!(rs.len(), SELL_RS_SIZE, "Sell RS must be 378 bytes");
