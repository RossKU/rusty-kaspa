...
pub const ACTIVE_LOAN_BODY: &[u8] = &[
    ...
    0x7c,                         // OpSwap -> (data, 144, len)                          [1B]
    0x7f,                         // OpSubstr -> old_suffix = data[144..len]             [1B]
    0x01, 0x12, 0x79,             // push(18) OpPick -> new_rs copy                     [3B]
    0x82,                         // OpSize                                              [1B]
    0x02, 0x90, 0x00,             // push 144 (begin)                                   [3B]
    0x7c,                         // OpSwap                                              [1B]
    0x7f,                         // OpSubstr -> new_suffix = data[144..len]             [1B]
    0x87, 0x69,                   // OpEqual OpVerify                                    [2B]
    // stack: [18]
    //
    ...
    0x7c,                         // OpSwap -> (data, 117, len)                          [1B]
    0x7f,                         // OpSubstr -> old_suffix = data[117..len]             [1B]
    0x01, 0x13, 0x79,             // push(19) OpPick -> new_rs copy                     [3B]
    0x82,                         // OpSize                                              [1B]
    0x01, 0x75,                   // push 117 (begin)                                   [2B]
    0x7c,                         // OpSwap                                              [1B]
    0x7f,                         // OpSubstr -> new_suffix = data[117..len]             [1B]
    0x87, 0x69,                   // OpEqual OpVerify                                    [2B]
    // stack: [19]
    //
    ...
    0x7c,                         // OpSwap -> (data, 66, len)                           [1B]
    0x7f,                         // OpSubstr -> old_suffix = data[66..len]              [1B]
    0x01, 0x12, 0x79,             // push(18) OpPick -> new_rs copy                     [3B]
    0x82,                         // OpSize                                              [1B]
    0x01, 0x42,                   // push 66 (begin)                                    [2B]
    0x7c,                         // OpSwap                                              [1B]
    0x7f,                         // OpSubstr -> new_suffix = data[66..len]              [1B]
    0x87, 0x69,                   // OpEqual OpVerify                                    [2B]
    // stack: [18]
    //
