...
pub async fn token_mint(
    ...
    // Build token_unit redeemScript for the recipient (38 bytes, KCC20 header)
...
mod tests {
    ...
    fn token_transfer_builders_consistent() {
        ...
        // (38B RS = KCC20 Standard State Header script portion (35B: owner_identifier +
        ...
        // [65] [sig 64B] [0x01] [38] [RS 38B] = 66 + 39 = 105
        assert_eq!(ss.len(), 105);
    }
