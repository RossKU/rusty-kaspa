...
pub async fn dispatch(
    ...
    match command {
        ...
        // TODO: replaced by new robust-stablecoin CLI migration. See the
        // gated-out `Attest`/`Stablecoin` variants above -- kept out of the
        // `Commands` enum, so these match arms are unreachable and disabled
        // too until the new-API CLI migration lands.
        //
